...
// history buffer (if enabled) and then relayed to all registered listeners.
...
// Delete removes the message from the history buffer (if enabled) and instructs listeners to do
// the same.
